...
const CAMPAIGN_QUERIES = [
  "Africa oceans fisheries offshore drilling marine protected area coastal communities",
  "Africa water scarcity river pollution dam drinking water sanitation drought flooding",
  "Africa biodiversity conservation wildlife habitat mining protected species ecosystem loss",
  "Africa forests deforestation logging land clearing forest governance protected forest",
  "Africa climate energy renewable transition methane coal gas electricity energy policy",
  "Africa plastics pollution waste management single-use plastics recycling landfill circular economy",
  "Africa oil gas LNG refinery pipeline offshore exploration spill licensing",
  "Africa food sovereignty agroecology seed systems farmers land rights food justice",
  "\"Greenpeace Africa\" environment campaign Africa",
];
...
// Priority sorting for Greenpeace Africa signals
...
export async function GET(request: Request) {
  ...
  try {
    const searchQueries = query ? [query] : CAMPAIGN_QUERIES;
